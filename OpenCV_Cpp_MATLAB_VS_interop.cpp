...
int main()
{
	...
	*/
	...
	engEvalString(ep, "cd C:/Users/summer2016/Desktop/Cpp_to_MATLAB/matlab_engine/matlab_dir");					// Change to active directory 

	// Read and display image:																																																																	
	cv::Mat img = cv::imread("image1.png", CV_LOAD_IMAGE_GRAYSCALE);
